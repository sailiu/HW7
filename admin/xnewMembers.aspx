<%@ Page Language="VB" AutoEventWireup="false" CodeFile="xnewMembers.aspx.vb" Inherits="newMembers" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="ID" DataSourceID="SqlDataSource1" DefaultMode="Insert" Height="50px" Width="205px">
            <Fields>
